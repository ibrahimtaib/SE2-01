...
-- AddForeignKey
ALTER TABLE "Application" ADD CONSTRAINT "Application_PROPOSAL_ID_fkey" FOREIGN KEY ("PROPOSAL_ID") REFERENCES "Proposal"("id") ON DELETE SET NULL ON UPDATE CASCADE;
